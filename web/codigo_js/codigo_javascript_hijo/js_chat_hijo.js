...
if (botonEnviar) {
    botonEnviar.addEventListener('click', function (event) {
        ...
        const idCastor = document.querySelector('input[name="idCastor"]').value;
        const idKit = document.querySelector('input[name="idKit"]').value;
        const emisor = document.querySelector('input[name="emisor"]').value;
        const txtMsj = document.querySelector('textarea[name="txtMsj"]').value;
