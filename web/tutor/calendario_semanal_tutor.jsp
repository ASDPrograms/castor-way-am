...
<html>
    <head>
        ...
        <link href="../estilos_css/estilos_tutor/css_calendario_semanal_tutor.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="top-div">
                <div class="nav-calendar">
                    ...
                    <button class="semanaVista">
                        ...
                        <p><a href="calendario_tutor.jsp" style="text-decoration: none; color: black">Agenda</a></p>
                    </button>
                </div>
...
//Días de meses 
        ...
        <div id="modalCrearActividad" class="modal-crear-actividad">
            <div class="modal-content-crear-actividad">
                <form action="formulario_procesa_tutor_calendario_sm.jsp" method="post" id="formulario-nuevo-habito" style="width: auto; height: 100%;">
        ...
        <script src="../codigo_js/codigo_javascript_tutor/js_calendario_semanal_tutor.js" type="text/javascript"></script>
    </body>
</html>