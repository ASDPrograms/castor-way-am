<%-- 
    Document   : editar_nota_hijo
    Created on : 7 dic 2024, 10:18:04 p.m.
    Author     : Alicia
--%>
                ...
                <form action="procesa_nota_hijo.jsp" method="POST" id="subir_nota">
                    <div class="form-content">
                        ...
                        <div class="estado-nota">
                            <div class="item-EdoNot-privacidad" onclick="cambiarPrivacidad()" style="cursor: pointer;">
                                <div class="img-nota-priv">
                                    <img src="../img/candado_cerrado.svg" class="candado_privacidad_nota" alt="Candado">
                                </div> 
                                <div class="boton-nota-priv">

                                    <button type="button" id="boton-privado" class="privacidad_nota" name="privacidad_nota" value="1">Privado</button>

                                    <button type="button" id="boton-publico" class="privacidad_nota" name="privacidad_nota" value="0" style="display: none;">
                                        Público
                                    </button>
                                </div>
